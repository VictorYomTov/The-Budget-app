...
var UIController = (function(){
    ...
    return {
        ...
        addListItem: function(obj, type){
            ...
            // repleace the placeholder text with some actual data
        ...
        displayMonth: function(){
            ...
            months = ['January', 'Fabruray', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'];
            month = months[now.getMonth()]; document.querySelector(DOMstring.dateLabel).textContent = month + ' ' + year;
        },
...
var controller = (function(budjetCtrl, UICtrl){
    ...
    var updateBudget = function(){
        ...
        // return the budget
        var budget = budjetCtrl.getBudget();
    ...
    var ctrlAddItem = function(){
        ...
        if(input.description !== "" && !isNaN(input.value) && input.value > 0 ){
            // add the item to the budjet controller
